...
function ckstyle() {
    var ck = {
        ...
        language: '', 
        flashvars: '{h->3}{wh->}',
        setup: '1,1,1,'+ckdata['adpreload']+',1,1,'+ckdata['adpreorder']+',1,'+ckdata['admarstatus']+',0,0,1,200,0,1,'+ckdata['adpaucls']+',0,1,1,1,2,10,3,0,'+ckdata['simplebar']+','+ckdata['cthidden']+','+ckdata['cthidtime']+',1,0,1,0,1,1,1,1,1,1,250,'+ckdata['logotime']+','+ckdata['advolume']+'0,0',
